...
enum L10nProductivityTables {
    ...
    private static let en = values(
        ...
        copied: "Copied ✓", failed: "Operation failed").merging([
            ...
            "permissions.drag.title": "Drag this permission card into Full Disk Access",
            "permissions.drag.subtitle": "Open Full Disk Access, then drag the Full Disk Access card into the list and enable its switch. ForgeSweep will recheck when you return.",
            "permissions.drag.help": "Drag this Full Disk Access card into the open list",
            ...
            "permissions.screen.detail": "Optional. Used only by the screenshot shortcut and editor.",
    ...
    private static let zhHans = values(
        ...
        copied: "已复制 ✓", failed: "操作失败").merging([
            ...
            "permissions.drag.title": "将此权限卡片拖入完全磁盘访问",
            "permissions.drag.subtitle": "打开“完全磁盘访问”，再将“完全磁盘访问”权限卡片拖入列表并开启右侧开关；返回后会自动重新检测。",
            "permissions.drag.help": "将此完全磁盘访问权限卡片拖到已打开的列表",
            ...
            "permissions.screen.detail": "可选，仅用于截图快捷键和截图编辑器。",
