...
clean_orphaned_container_stubs() {
    # GUI background scans must not trigger macOS's "other App data" prompt.
    # Deep container coverage is enabled only after Full Disk Access has been
    # positively confirmed by the caller.
